        ...
        <div className="i" id="i">
            <div className="i-left">
                <div className="i-left-wrapper">
                    ...
                    <div className="i-desc">I'm a software developer and aspire to work in software development. I have worked as a software
                    tester which is an important quality in developing a software with fewer bugs. I've also done a few administrative jobs 
                    which requires great attention to details.</div>
                </div>    
            </div>
        </div>
    );
